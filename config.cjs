...
const config = {
  SESSION_ID: process.env.SESSION_ID || "Ethix-MD&MZkkUSXE",
  PREFIX: process.env.PREFIX || '.',
  AUTO_STATUS_SEEN: process.env.AUTO_STATUS_SEEN !== undefined ? process.env.AUTO_STATUS_SEEN === 'fslse' : true, 
  ...
  OWNER_NUMBER: process.env.OWNER_NUMBER || "2347065354875",
